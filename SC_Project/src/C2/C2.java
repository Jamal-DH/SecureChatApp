...
public class C2 extends JFrame { // C2 class extending JFrame to create a GUI window
    ...
    private void initialize() {
        setTitle("Client 2"); // Set the title of the GUI window
    ...
    private void setupNetworking() {
        int port = 5001; // Port number for the connection
        try {
            ...
            socketWriter = new PrintWriter(socket.getOutputStream(), true); // Initialize PrintWriter for sending messages
